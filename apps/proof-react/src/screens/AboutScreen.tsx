...
export const ABOUT_SOURCE = `<AboutScreen>
  <ScrollRegion title="About Destination Atlas" maxHeight="…">
    {/* Intro, runtime npm packages (not palette components), Component source panel, docs */}
  </ScrollRegion>
</AboutScreen>`;
...
export function AboutScreen() {
  return (
    <section className="da-panel da-panel--about">
      <ScrollRegion
        className="da-about-scroll"
        title="About Destination Atlas"
        maxHeight="var(--da-about-scroll-max)"
      >
        <div className="da-about">
          ...
          <section className="da-about__section">
            ...
            <ol className="da-about__steps">
              <li>
                Open <strong>Storybook</strong> for your runtime — browse palette groups, preview bindings, and
                copy import paths from the catalog.
              </li>
              <li>
                Run the matching <strong>proof app</strong> — see components composed into real screens (this React
                app is the reference implementation).
              </li>
              <li>
                On any other tab, read the <strong>Component source</strong> panel — inspect JSX structure, prop
                names, and how RosettaDash imports nest together.
              </li>
              <li>
                Install packages in your app via npm; wire developer-owned i18n, data, and providers (map tiles, API
                keys) at the component prop level.
              </li>
            </ol>
          </section>
