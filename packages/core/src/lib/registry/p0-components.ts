...
export const P0_COMPONENT_DEFINITIONS: ComponentDefinition[] = [
  ...
  },
  {
    ...
    category: 'visual',
    label: 'Journey Sankey',
    description: 'SVG flow chart for journeys, funnels, and branching paths',
    isVisual: true,
    inputs: [{ id: 'data', name: 'data', dataType: 'rowset' }],
    outputs: [],
    properties: [{ key: 'title', label: 'Title', type: 'string', default: 'Journey flow' }],
  },
  {
    type: 'visual.chart.venn',
    category: 'visual',
    label: 'Venn Overlap',
    description: 'SVG overlap diagram for audience or segment intersection',
    isVisual: true,
    inputs: [{ id: 'data', name: 'data', dataType: 'rowset' }],
    outputs: [],
    properties: [{ key: 'title', label: 'Title', type: 'string', default: 'Overlap diagram' }],
  },
  {
    type: 'visual.media.carousel',
    category: 'visual',
    label: 'Slide Carousel',
    description: 'Thumbnail carousel with prev/next navigation and dot indicators',
    isVisual: true,
    inputs: [{ id: 'slides', name: 'slides', dataType: 'rowset' }],
    outputs: [{ id: 'selectedId', name: 'selectedId', dataType: 'string' }],
    properties: [{ key: 'title', label: 'Title', type: 'string', default: 'Carousel' }],
  },
  {
    type: 'layout.grid',
    category: 'layout',
